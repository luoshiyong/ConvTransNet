...
class ConvTransBlock(nn.Module):
    ...
    def forward(self, x, x_t):
        ...
        # xst->[b,441,384]
        # attention
        print("xst shape = {} | xt shape ={}".format(x_st.shape,x_t.shape))
...
class Conformer(nn.Module):
    ...
    def forward(self, x):
        ...
        # [b,64,84,84]->[b,441,21,21]->[b,441,441](b,c,hw)->[b,441,441](b,hw,c)
...
model = Conformer(patch_size=16,channel_ratio=2,embed_dim=441,depth=12,num_heads=9,mlp_ratio=4,qkv_bias=False)
out = model(input)
